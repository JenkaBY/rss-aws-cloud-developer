package by.jenka.rss.productservice.lambda.test;
...
import static by.jenka.rss.productservice.lambda.config.DBConfig.enhancedClient;
...
public class DynamoDbTest {
    ...
    void run() {
        ...
        var productEntities = new DefaultProductRepository(enhancedClient).findAll();
